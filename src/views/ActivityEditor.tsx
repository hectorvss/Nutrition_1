        ...
        <div className="bg-white w-full rounded-3xl shadow-xl border border-slate-200 flex flex-col h-auto min-h-[calc(100vh-4rem)]">
          ...
          <div className="px-8 py-6 border-b border-slate-100 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-slate-900 leading-tight">Edit Activity</h2>
            ...
            <div className="p-8 overflow-y-auto space-y-10 h-full scrollbar-hide">
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="md:col-span-2">
                    <label className="block text-xs font-bold text-slate-500 mb-2 uppercase tracking-widest">Activity Name</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-500 mb-2 uppercase tracking-widest">Muscle Group</label>
                    <div className="relative">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-500 mb-2 uppercase tracking-widest">Equipment</label>
                    <div className="relative">
                      <select className="w-full px-4 py-3.5 rounded-2xl border border-slate-200 bg-slate-50 text-slate-900 focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition-all appearance-none cursor-pointer font-bold text-sm">
              ...
              <section>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="text-[10px] font-bold text-emerald-500 hover:text-emerald-600 uppercase tracking-widest">Reset to Default</button>
                </div>
                <div className="grid grid-cols-3 gap-6 mb-8">
                  <button className="flex flex-col items-center justify-center p-6 rounded-3xl border-2 border-emerald-500 bg-emerald-50/50 text-emerald-600 relative shadow-sm transition-all">
                    ...
                    <span className="font-black text-sm uppercase tracking-widest mb-1">Hypertrophy</span>
                  ...
                  <button className="flex flex-col items-center justify-center p-6 rounded-3xl border border-slate-200 hover:border-emerald-500/50 hover:bg-slate-50 text-slate-400 transition-all bg-white">
                    <span className="font-black text-sm uppercase tracking-widest mb-1">Strength</span>
                    <span className="text-[10px] font-bold bg-slate-100 px-2 py-0.5 rounded-full uppercase tracking-tight">5 x 5</span>
                  </button>
                  <button className="flex flex-col items-center justify-center p-6 rounded-3xl border border-slate-200 hover:border-emerald-500/50 hover:bg-slate-50 text-slate-400 transition-all bg-white">
                    <span className="font-black text-sm uppercase tracking-widest mb-1">Endurance</span>
                    ...
                    <div key={set.id} className="p-5 rounded-3xl border border-slate-100 bg-slate-50/50">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Set {set.id}</span>
                          {set.warmup && (
                            <span className="text-[9px] font-black bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-lg uppercase tracking-widest">Warm-up</span>
                          )}
                        </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div>
                          <label className="block text-[9px] font-black text-slate-400 mb-2 uppercase tracking-widest">Reps</label>
                        ...
                        <div>
                          <label className="block text-[9px] font-black text-slate-400 mb-2 uppercase tracking-widest">Weight (kg)</label>
                        ...
                        <div>
                          <label className="block text-[9px] font-black text-slate-400 mb-2 uppercase tracking-widest">RPE / RIR</label>
                        ...
                        <div>
                          <label className="block text-[9px] font-black text-slate-400 mb-2 uppercase tracking-widest">Rest</label>
                  ...
                  <div className="absolute bottom-4 right-4 flex items-end gap-3 z-10 group">
                    <div className="opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 bg-white border border-slate-200 shadow-2xl rounded-2xl p-4 w-64 mb-2 origin-bottom-right">
                      ...
                      <div className="flex flex-col gap-1">
                        <button className="text-left px-3 py-2 rounded-xl hover:bg-slate-50 text-[10px] font-bold text-slate-600 uppercase tracking-widest transition-colors">Generate form cues</button>
                        <button className="text-left px-3 py-2 rounded-xl hover:bg-slate-50 text-[10px] font-bold text-slate-600 uppercase tracking-widest transition-colors">Suggest alternatives</button>
                        <button className="text-left px-3 py-2 rounded-xl hover:bg-slate-50 text-[10px] font-bold text-slate-600 uppercase tracking-widest transition-colors">Summarize benefits</button>
                      </div>
                    </div>
