                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full bg-transparent border-none p-0 text-3xl font-bold tracking-tight text-slate-900 dark:text-white focus:ring-0 outline-none focus:outline-none focus:border-none placeholder:text-slate-200 ${isFixedStep ? 'cursor-default' : ''}`}
                      />
                      <textarea
                        readOnly={isFixedStep}
                        ...
                        className={`w-full bg-transparent border-none p-0 text-lg font-medium text-slate-400 focus:ring-0 outline-none focus:outline-none focus:border-none resize-none h-14 placeholder:text-slate-200 shadow-none border-transparent ring-0 ${isFixedStep ? 'cursor-default' : ''}`}
                      />
                    </div>
                    {!isFixedStep && (
                      <button
