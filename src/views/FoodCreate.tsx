      ...
      <div className="flex-1 h-full overflow-y-auto p-6 lg:p-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-500">
            ...
            <span className="text-slate-900 font-bold">Add New Food</span>
          </div>
          ...
          <div className="bg-white rounded-[16px] shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div className="px-8 py-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Add a new food item to your personal database.</p>
              </div>
            ...
            <div className="p-8 space-y-8">
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-slate-900 mb-2">Food Name</label>
                    <input 
                      type="text" 
                      value={name}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-900 mb-2">
                      Brand / Manufacturer <span className="text-slate-500 font-normal">(Optional)</span>
                    </label>
                    <input 
                      type="text" 
                      className="w-full px-4 py-2.5 rounded-xl border-slate-200 bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all shadow-sm text-sm"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-900 mb-2">Standard Serving Size</label>
              ...
              <section>
                <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wider mb-4 flex items-center gap-2">
                  ...
                  Macronutrients <span className="text-slate-500 text-xs normal-case font-normal ml-1">(per serving)</span>
                </h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    ...
                    { label: 'Fat', unit: 'g', val: fats, set: setFats }
                  ].map((macro) => (
              ...
              <section>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs px-2 py-1 bg-slate-100 text-slate-500 rounded font-medium">Optional</span>
                </div>
