...
export default function NutritionNoPlan({ client, onBack, onStartPlan }: NutritionNoPlanProps) {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 p-6 pt-2 lg:items-start">
        ...
        {/* Right Column — FLOATING: sticks in the viewport while the left
            preset list scrolls, same behaviour as Planning / Training. */}
        <div className="w-full lg:basis-[30%] lg:shrink-0 flex flex-col gap-4 lg:sticky lg:top-4 lg:self-start lg:h-[calc(100vh-2rem)] min-h-0">
          {/* Scrollable area — the summary card scrolls; the settings card
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 text-center shadow-sm shrink-0">
          ...
          </div>{/* end scrollable summary area */}

          {/* Always-visible settings card — pinned at a fixed height. */}
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 flex flex-col gap-5 shadow-sm flex-shrink-0 overflow-y-auto scrollbar-hide">
