...
export default function WeeklyCheckinFlow({ onComplete, onCancel }: WeeklyCheckinFlowProps) {
  ...
  const [currentStep, setCurrentStep] = useState(0); // 0 = Intro, 1..N = Steps, N+1 = Finish
        ...
        <div className="max-w-3xl mx-auto w-full space-y-8">
           <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-8">
             <div className="flex items-center justify-between mb-8">
               <h3 className="text-xl font-bold text-slate-900 dark:text-white">Weekly Progress Review</h3>
      ...
      <div className="relative z-10 px-6 py-5 border-b border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/70 backdrop-blur-md flex items-center justify-between">
         <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
               ...
               <h2 className="text-sm font-bold text-slate-900 dark:text-white leading-none">Weekly Progress</h2>
            </div>
         </div>
         <div className="flex items-center gap-4">
