...
export default function WeeklyCheckinFlow({ onComplete, onCancel }: WeeklyCheckinFlowProps) {
      ...
      <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
        ...
        <div className="grid grid-cols-3 gap-4">
          {['Front', 'Side', 'Back'].map(view => (
            <div key={view} className="aspect-[3/4] rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-slate-400 hover:border-[#17cf54] hover:text-[#17cf54] transition-all cursor-pointer group bg-slate-50/50 dark:bg-slate-800/20">
  ...
  const renderPage4 = () => (
    <Section title="Digestion & Satiety" subtitle="Internal biofeedback is key to adjusting your plan." icon="stomach">
      ...
      <div>
        <FieldLabel>Food-Related Notes</FieldLabel>
        <textarea placeholder="Any specific foods causing issues or digestive patterns?" value={answers.foodNotes} onChange={e => updateAnswer('foodNotes', e.target.value)}
          className="w-full p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 text-slate-900 dark:text-white min-h-[100px] focus:border-[#17cf54] focus:ring-0 outline-none resize-none transition-all text-sm" />
      </div>
    </Section>
  );
  ...
  const renderPage7 = () => (
    <Section title="Recovery & Sleep" subtitle="The foundation of your progress happens while you rest." icon="dark_mode">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6 pt-4 border-t border-slate-100 dark:border-slate-800">
  ...
  const renderPage11 = () => (
    <Section title="Final Review" subtitle="Review your data points before locking in your week." icon="fact_check">
      ...
      <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
        <FieldLabel>Any final thoughts or extra notes?</FieldLabel>
        <textarea placeholder="Anything else you want to share before locking in your week?" value={answers.extraNotes} onChange={e => updateAnswer('extraNotes', e.target.value)}
          className="w-full p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 text-slate-900 dark:text-white min-h-[100px] focus:border-[#17cf54] focus:ring-0 outline-none resize-none transition-all text-sm" />
      </div>
    </Section>
  );
